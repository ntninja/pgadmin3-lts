	...
	: wxPanel(nb, -1, wxDefaultPosition, wxDefaultSize)
{
	...
	sizer1->Add(lbSeclabels, 0, wxEXPAND | wxBOTTOM | wxTOP | wxLEFT | wxRIGHT, 4);
	sizer0->Add(sizer1, 0, wxEXPAND | wxALL, 5);

	// buttons sizer
	wxBoxSizer *sizer2 = new wxBoxSizer(wxHORIZONTAL);
	btnAddSeclabel = new wxButton(this, CTL_ADDSECLABEL, _("Add/Change"));
	sizer2->Add(btnAddSeclabel, 0, wxALIGN_CENTRE_VERTICAL | wxTOP | wxLEFT | wxRIGHT, 4);
	btnDelSeclabel = new wxButton(this, CTL_DELSECLABEL, _("Remove"));
	sizer2->Add(btnDelSeclabel, 0, wxALIGN_CENTRE_VERTICAL | wxTOP | wxLEFT | wxRIGHT, 4);
	...
	sizer3->Add(label, 0, wxALIGN_CENTRE_VERTICAL | wxTOP | wxLEFT | wxRIGHT, 4);
