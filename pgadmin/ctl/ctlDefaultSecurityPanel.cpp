	  ...
	  m_privilegeType(privOn), m_defSecurityPanel(defSecurityPanel)
{
	...
	itemSizer1->Add(lbPrivileges, 0, wxEXPAND | wxBOTTOM | wxTOP | wxLEFT | wxRIGHT, 4);
	item0->Add(itemSizer1, 0, wxEXPAND | wxALL, 5);

	wxBoxSizer *itemSizer2 = new wxBoxSizer(wxHORIZONTAL);
	btnAddPriv = new wxButton(this, CTL_DEFADDPRIV, _("Add/Change"));
	itemSizer2->Add(btnAddPriv, 0, wxALIGN_CENTRE_VERTICAL | wxTOP | wxLEFT | wxRIGHT, 4);
	btnDelPriv = new wxButton(this, CTL_DEFDELPRIV, _("Remove"));
	itemSizer2->Add(btnDelPriv, 0, wxALIGN_CENTRE_VERTICAL | wxTOP | wxLEFT | wxRIGHT, 4);
	...
	itemSizer4a->Add(stGroup, 0, wxALIGN_CENTRE_VERTICAL | wxTOP | wxLEFT | wxRIGHT, 4);
	...
	itemSizer5->Add(allPrivileges, wxALIGN_CENTRE_VERTICAL | wxTOP | wxLEFT | wxRIGHT);
	allPrivilegesGrant = new wxCheckBox(this, CTL_DEFALLPRIVGRANT, wxT("WITH GRANT OPTION"));
	itemSizer5->Add(allPrivilegesGrant, wxALIGN_CENTRE_VERTICAL | wxTOP | wxLEFT | wxRIGHT);
	...
	for (int index = 0; index < privilegeCount; index++)
	{
		...
		itemSizer6->Add(cb, wxALIGN_CENTRE_VERTICAL | wxTOP | wxLEFT | wxRIGHT);
		privCheckboxes[i++] = cb;
